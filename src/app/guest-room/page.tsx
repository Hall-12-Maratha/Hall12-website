          ...
          <CardContent className="grid md:grid-cols-2 gap-8 text-lg">
            ...
            <div>
              <div className="flex items-center gap-4">
                ...
                <p><strong>AC Rooms:</strong> ₹1500/- per day</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <Button asChild variant="link" className="p-0 h-auto text-accent">
                <a href="https://calendar.google.com/calendar/embed?src=akashkumarsingh214%40gmail.com&ctz=Asia/Calcutta" target="_blank" rel="noopener noreferrer">Guest Room Availability Sheet</a>
              </Button>
              </div>
            </div>
            <div className="flex items-start gap-4">
